...
import {Box, AppBar, Toolbar, Typography, InputBase, styled} from "@mui/material"
...
const UserBox = styled(Box)(({theme}) =>({display:"flex", gap:"20px", alignItems:"center", [theme.breakpoints.up('sm')]:{
  display:"none",
}}));
      ...
      <AppBar position="sticky">
        <StyledToolbar>
            ...
            <Icons>
                ...
                <Avatar sx={{width:30, height:30}} alt="Profile picture" src=""  onClick={(e)=>setOpen(true)}/>
